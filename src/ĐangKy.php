...
<head>
    ...
    <title>Đăng ký tài khoản - Hệ thống Văn phòng phẩm</title>
        ...
        <form action="XuLyDangKy.php" method="POST">
            <div class="mb-3">
                ...
                <div class="input-group border rounded-3 p-1">
                    <input type="text" name="ho_ten" class="form-control border-0 shadow-none" placeholder="Nhập họ và tên" required>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group border rounded-3 p-1">
                    <input type="text" name="tai_khoan" class="form-control border-0 shadow-none" placeholder="Tên tài khoản" required>
                </div>
            </div>
            ...
            <button type="submit" class="btn btn-register w-100 py-2 rounded-3 fw-bold mb-4">Đăng ký ngay</button>

            <p class="text-center mb-0 text-muted">
                Đã có tài khoản?
                <a href="ĐangNhap.php" class="text-decoration-none fw-bold" style="color: #8b3dff;">Đăng nhập</a>
            </p>
        </form>
    </div>
</body>
