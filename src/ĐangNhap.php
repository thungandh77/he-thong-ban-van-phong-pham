    ...
    <div class="login-card p-4 shadow-sm bg-white rounded-4">
        ...
        <form action="XuLyDangNhap.php" method="POST">
            ...
            <div class="d-flex justify-content-between mb-4">
                ...
                <a href="#" class="text-decoration-none small" style="color: #8b3dff;">
                    Quên mật khẩu?
                </a>
            </div>

            <button type="submit" class="btn btn-gradient w-100 py-2 rounded-3 fw-bold mb-4">
                Đăng nhập
            </button>

            <div class="divider d-flex align-items-center mb-4 text-muted small">
                Hoặc
            </div>
            ...
            <div class="row g-2">
                ...
                <div class="col-6">
                    <button type="button"
                        class="btn btn-outline-secondary w-100 py-2 d-flex align-items-center justify-content-center gap-2 rounded-3 border-light-subtle text-dark small fw-semibold">
                ...
                <div class="col-6">
                    <button type="button"
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/0/05/Facebook_Logo_%282019%29.png" width="16">
